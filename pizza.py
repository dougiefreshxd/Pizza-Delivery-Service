        ...
        for x in newdict[starting_point].keys(): 
            if x == ending_point: 
                ...
                for y in self.already_used: 
                    if y == x:
                        if y == starting_point:
                            print(f"Current item we are viewing in our already used list is {y}")
                            print(f"Current key we are using from the house is {starting_point}")
                            print(f"We are looking at value {x}")
